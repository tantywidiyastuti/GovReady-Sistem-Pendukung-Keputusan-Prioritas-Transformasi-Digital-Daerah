...
def load_ml_pipeline():
    try:
        with open("C:/Users/arielva/Downloads/GovReady-DSS/govready_pipeline.pkl", "rb") as f:
...
GEOJSON_MATANG_PATH = "C:/Users/arielva/Downloads/GovReady-DSS/indonesia_kabupaten.geojson"
...
if 'active_df' not in st.session_state or uploaded_dataset is not None:
    if uploaded_dataset is not None:
        ...
        try:
            st.session_state.active_df = process_and_cluster_data("C:/Users/arielva/Downloads/GovReady-DSS/Dataset_Hasil_Imputasi  - Dataset_Hasil_Imputasi (1).csv")
        except:
